...
int main()
{
    ...
    // Yêu cầu nhập số lượng sinh viên N trong khoảng 2 đến 20
    do {
    ...
    // In giao diện danh sách sinh viên (Header giữ nguyên định dạng từ Homework 1)
    cout << "\n========================================\n";
    cout << "            STUDENT LIST\n";
    cout << "========================================\n\n";

    // Vòng lặp xuất thông tin sinh viên
    for (int i = 0; i < N; i++) {
        cout << "Student " << i + 1 << ":\n";
        cout << "  Name:  " << names[i] << "\n";
